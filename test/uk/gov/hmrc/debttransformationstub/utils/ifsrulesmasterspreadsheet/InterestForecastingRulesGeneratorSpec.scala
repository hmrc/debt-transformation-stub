    ...
    "for the use case on 2024-08-24 for DTD-2418" - {
      ...
      val inputCaseFromTsvFile = InputCase(
        ...
        () =>
          ApplicationInputs.oneFileAtMostOnce(
            ...
            fileContent = Data.`Sample--2024-08-24--DTD-2418`.tsvInput()
          )
      )
      val inputCaseFromCleanCsvFile = InputCase(
        ...
        () =>
          ApplicationInputs.oneFileAtMostOnce(
            ...
            fileContent = Data.`Sample--2024-08-24--DTD-2418`.csvInputWithCleanHeadings()
          )
      )
      val inputCaseFromMessyCsvFile = InputCase(
        ...
        () =>
          ApplicationInputs.oneFileAtMostOnce(
            filename = "/some/file/path/master-ifs-data-august-2024.csv",
            fileContent = Data.`Sample--2024-08-24--DTD-2418`.csvInputWithMessyHeadings()
          )
      )
      val inputCaseFromTsvConsole = InputCase(
        ...
        () =>
          ApplicationInputs.consoleFromExactString(
            stdinContent = Data.`Sample--2024-08-24--DTD-2418`.tsvInput() + "\nEND_INPUT"
          )
      )
      ...
      val outputCaseAsIfsScala = OutputFormatCase(
        ...
        expectedOutput = () => Data.`Sample--2024-08-24--DTD-2418`.outputScalaIfsConf()
      )
      val outputCaseAsApplicationConf = OutputFormatCase(
        ...
        expectedOutput = () => Data.`Sample--2024-08-24--DTD-2418`.outputApplicationConf()
      )
  ...
  private object Data {
    object `Sample--2024-08-24--DTD-2418` {
      ...
      def outputScalaIfsConf(): String = {
        val path =
          "test/resources/InterestForecastingRulesGenerator/samples/2024-08-24--DTD-2418/output-ifs-scala-config.txt"
        Using(scala.io.Source.fromFile(path))(_.mkString).get
      }
    }
  }
