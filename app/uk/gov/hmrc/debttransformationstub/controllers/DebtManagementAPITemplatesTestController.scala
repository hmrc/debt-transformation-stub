...
import uk.gov.hmrc.debttransformationstub.models.debtmanagment.templateRequest
...
@Singleton()
class DebtManagementAPITemplatesTestController @Inject()(
  appConfig: AppConfig,
  ...
  def fieldCollectionsTemplates(): Action[templateRequest] =
    Action.async(parse.tolerantJson[templateRequest]) { request =>
